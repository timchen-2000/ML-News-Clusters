...
kmeans.fit(reduced_tfidf_matrix_100)
...
# 保存带有聚类结果和基本信息的数据
clustered_data_with_info_path = r'D:\machine_learning_class_project\datasets\Clustered_kmeans_100.csv'
...
colors = plt.cm.Paired(np.linspace(0, 1, n_clusters))
...
plt.title('t-SNE Visualization of K-means')
